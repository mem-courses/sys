...
#slide2x([3], image("../public/merged-2-1/0003.jpg"), image("../public/translated-2-1/0003.jpg"), cb: 0.2)

#slide2x([4], image("../public/merged-2-1/0004.jpg"), image("../public/translated-2-1/0004.jpg"))

- *随机存取存储器(random access memory, RAM)*
  - *静态随机存取存储器(static RAM, SRAM)*：快、贵、数据“永久”保留直到断电。
  - *动态随机存取存储器(dynamic RAM, DRAM)*：慢、便宜、需要定期“刷新”。

#slide2x([5], image("../public/merged-2-1/0005.jpg"), image("../public/translated-2-1/0005.jpg"))

#slide2x([6], image("../public/merged-2-1/0006.jpg"), image("../public/translated-2-1/0006.jpg"), cb: 0.34)
...
#quote[
  *内存层次结构*
  ...
  #align(center, image("images/2025-03-31-20-35-33.png", width: 64%))
]
...
#slide2x([12], image("../public/merged-2-1/0012.jpg"), image("../public/translated-2-1/0012.jpg"))

#slide2x([13], image("../public/merged-2-1/0013.jpg"), image("../public/translated-2-1/0013.jpg"))
...
#slide2x([20], image("../public/merged-2-1/0020.jpg"), image("../public/translated-2-1/0020.jpg"))

#slide2x([21], image("../public/merged-2-1/0021.jpg"), image("../public/translated-2-1/0021.jpg"))

#slide2x([22], image("../public/merged-2-1/0022.jpg"), image("../public/translated-2-1/0022.jpg"))

#slide2x([23], image("../public/merged-2-1/0023.jpg"), image("../public/translated-2-1/0023.jpg"))
...
#slide2x([40], image("../public/merged-2-1/0040.jpg"), image("../public/translated-2-1/0040.jpg"), cb: 0.15)
...
#slide2x([42], image("../public/merged-2-1/0042.jpg"), image("../public/translated-2-1/0042.jpg"))

#slide2x([43], image("../public/merged-2-1/0043.jpg"), image("../public/translated-2-1/0043.jpg"))

#slide2x([44], image("../public/merged-2-1/0044.jpg"), image("../public/translated-2-1/0044.jpg"))

#slide2x([45], image("../public/merged-2-1/0045.jpg"), image("../public/translated-2-1/0045.jpg"), cb: 0.2)

#slide2x([46], image("../public/merged-2-1/0046.jpg"), image("../public/translated-2-1/0046.jpg"), cb: 0.24)

#slide2x([47], image("../public/merged-2-1/0047.jpg"), image("../public/translated-2-1/0047.jpg"))

#slide2x([48], image("../public/merged-2-1/0048.jpg"), image("../public/translated-2-1/0048.jpg"))

#slide2x([49], image("../public/merged-2-1/0049.jpg"), image("../public/translated-2-1/0049.jpg"))

#slide2x([50], image("../public/merged-2-1/0050.jpg"), image("../public/translated-2-1/0050.jpg"), cb: 0.2)

#slide2x([51], image("../public/merged-2-1/0051.jpg"), image("../public/translated-2-1/0051.jpg"))

#slide2x([52], image("../public/merged-2-1/0052.jpg"), image("../public/translated-2-1/0052.jpg"))

#slide2x([53], image("../public/merged-2-1/0053.jpg"), image("../public/translated-2-1/0053.jpg"))

#slide2x([54], image("../public/merged-2-1/0054.jpg"), image("../public/translated-2-1/0054.jpg"))

#slide2x([55], image("../public/merged-2-1/0055.jpg"), image("../public/translated-2-1/0055.jpg"))

#slide2x([56], image("../public/merged-2-1/0056.jpg"), image("../public/translated-2-1/0056.jpg"))

#slide2x([57], image("../public/merged-2-1/0057.jpg"), image("../public/translated-2-1/0057.jpg"))

#slide2x([58], image("../public/merged-2-1/0058.jpg"), image("../public/translated-2-1/0058.jpg"))

？

#slide2x([59], image("../public/merged-2-1/0059.jpg"), image("../public/translated-2-1/0059.jpg"))

#slide2x([60], image("../public/merged-2-1/0060.jpg"), image("../public/translated-2-1/0060.jpg"))

#slide2x([61], image("../public/merged-2-1/0061.jpg"), image("../public/translated-2-1/0061.jpg"))
...
#slide2x([2], image("../public/merged-2-2/0002.jpg"), image("../public/translated-2-2/0002.jpg"))

#slide2x([3], image("../public/merged-2-2/0003.jpg"), image("../public/translated-2-2/0003.jpg"))

#slide2x([4], image("../public/merged-2-2/0004.jpg"), image("../public/translated-2-2/0004.jpg"))

#slide2x([5], image("../public/merged-2-2/0005.jpg"), image("../public/translated-2-2/0005.jpg"))

#slide2x([6], image("../public/merged-2-2/0006.jpg"), image("../public/translated-2-2/0006.jpg"))

#slide2x([7], image("../public/merged-2-2/0007.jpg"), image("../public/translated-2-2/0007.jpg"))

#slide2x([8], image("../public/merged-2-2/0008.jpg"), image("../public/translated-2-2/0008.jpg"))

#slide2x([9], image("../public/merged-2-2/0009.jpg"), image("../public/translated-2-2/0009.jpg"))

#slide2x([10], image("../public/merged-2-2/0010.jpg"), image("../public/translated-2-2/0010.jpg"))
...
#slide2x([13], image("../public/merged-2-2/0013.jpg"), image("../public/translated-2-2/0013.jpg"))

#slide2x([14], image("../public/merged-2-2/0014.jpg"), image("../public/translated-2-2/0014.jpg"))

#slide2x([15], image("../public/merged-2-2/0015.jpg"), image("../public/translated-2-2/0015.jpg"))

#slide2x([16], image("../public/merged-2-2/0016.jpg"), image("../public/translated-2-2/0016.jpg"))

#slide2x([17], image("../public/merged-2-2/0017.jpg"), image("../public/translated-2-2/0017.jpg"))

#slide2x([18], image("../public/merged-2-2/0018.jpg"), image("../public/translated-2-2/0018.jpg"))

#slide2x([19], image("../public/merged-2-2/0019.jpg"), image("../public/translated-2-2/0019.jpg"))

#slide2x([20], image("../public/merged-2-2/0020.jpg"), image("../public/translated-2-2/0020.jpg"))

#slide2x([21], image("../public/merged-2-2/0021.jpg"), image("../public/translated-2-2/0021.jpg"))

#slide2x([22], image("../public/merged-2-2/0022.jpg"), image("../public/translated-2-2/0022.jpg"))

#slide2x([23], image("../public/merged-2-2/0023.jpg"), image("../public/translated-2-2/0023.jpg"))

#slide2x([24], image("../public/merged-2-2/0024.jpg"), image("../public/translated-2-2/0024.jpg"))
...
#slide2x([93], image("../public/merged-2-2/0093.jpg"), image("../public/translated-2-2/0093.jpg"))

#slide2x([94], image("../public/merged-2-2/0094.jpg"), image("../public/translated-2-2/0094.jpg"))

#slide2x([95], image("../public/merged-2-2/0095.jpg"), image("../public/translated-2-2/0095.jpg"))
